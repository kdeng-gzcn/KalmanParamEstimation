...
with open(path, "a") as f:
    ...
    model = KalmanClass.GradientParameterEstimationA(A=np.array([[1., 0.], [0., 1.]]), Sigma_q=np.array([[0.01, 0.], [0., 0.01]]), H=np.array([[1., 0.], [0., 1.]]), Sigma_r=np.array([[0.01, 0.], [0., 0.01]]), mu_0=np.array([0., 0.]), P_0=np.array([[0.01, 0.], [0., 0.01]]))
